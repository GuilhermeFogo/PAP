...
/**
 * Servlet implementation class PesquisaGeneroProducao
 */
@WebServlet("/PesquisaGeneroProducao")
public class PesquisaGeneroProducao extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PesquisaGeneroProducao() {
        super();
